  ...
  const processes = [
    {
      icon: <BsPeople />,
      title: '전문 인력 구성',
      description: '하자 점검 전문 인력 2인 1조로 구성되어 꼼꼼한 점검을 진행합니다.'
    },
    {
      icon: <BsClock />,
      title: '점검 소요 시간',
      description: '84타입 기준 약 2시간 소요되며, 완료 후 발견된 하자에 관해 브리핑을 진행합니다.'
    },
    {
    ...
    },
    {
      icon: <BsCamera />,
      title: 'VR 컨텐츠',
      description: '점검 당일 촬영된 VR 컨텐츠는 2주주 이내에 업로드되어 확인하실 수 있습니다.'
    }
  ];
